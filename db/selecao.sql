...
--
-- Create database "selecao_phpdev2016"
--
CREATE DATABASE selecao_phpdev2016
  CHARACTER SET utf8
...
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TEMPORARY TABLES, CREATE VIEW, DROP, EVENT, EXECUTE, GRANT OPTION, INDEX, LOCK TABLES, REFERENCES, SHOW VIEW, TRIGGER ON selecao_phpdev2016.* TO 'selecao_phpdev'@'localhost';